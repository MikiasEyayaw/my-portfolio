...
import { FaLaptopCode, FaTools, FaCodeBranch } from 'react-icons/fa';
      ...
      <div className={`max-w-4xl mx-auto ${cardBg} p-8 rounded-2xl shadow-lg border ${borderColor} mb-12`}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 text-lg">
          <div className="flex items-center gap-3">
            <SiVisualstudiocode className="text-blue-500" size={30} />
            <span>VS Code</span>
          </div>
          <div className="flex items-center gap-3">
            <SiGithub className="text-gray-600" size={30} />
            <span>GitHub</span>
          </div>
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            <FaLaptopCode className="text-green-500" size={30} />
            <span>DevTools</span>
          </div>
          <div className="flex items-center gap-3">
            <SiFigma className="text-pink-500" size={30} />
            <span>Figma</span>
          </div>
        </div>
      </div>

      {/* Color Highlights, Hover Effects, and Modern Layout */}
      <div className="flex justify-center items-center gap-6 mt-12 mb-6">
        <div className="flex items-center justify-center bg-indigo-600 text-white p-4 rounded-xl shadow-md hover:bg-indigo-700 transition-all duration-300 cursor-pointer">
          <FaTools size={24} />
